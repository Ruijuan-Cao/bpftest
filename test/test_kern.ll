...
@llvm.used = appending global [4 x i8*] [i8* getelementptr inbounds ([4 x i8], [4 x i8]* @_license, i32 0, i32 0), i8* bitcast (%struct.bpf_map_def* @bpf_pass_map to i8*), i8* bitcast (i32 (%struct.xdp_md*)* @xdp_parser_func to i8*), i8* bitcast (i32 (%struct.xdp_md*)* @xdp_pass_func to i8*)], section "llvm.metadata"
...
define dso_local i32 @xdp_pass_func(%struct.xdp_md* nocapture readnone) #0 section "xdp_pass" {
  ...
  %4 = call i8* inttoptr (i64 1 to i8* (i8*, i8*)*)(i8* bitcast (%struct.bpf_map_def* @bpf_pass_map to i8*), i8* nonnull %3) #3
  %5 = icmp eq i8* %4, null
...
define dso_local i32 @xdp_parser_func(%struct.xdp_md* nocapture readonly) #2 section "xdp_ipv6_pass" {
...
29:                                               ; preds = %25
  ...
  %32 = load i16, i16* %31, align 1, !tbaa !9
...
37:                                               ; preds = %33
  ...
  %40 = load i16, i16* %39, align 1, !tbaa !9
...
45:                                               ; preds = %41
  ...
  %48 = load i16, i16* %47, align 1, !tbaa !9
  br label %49

49:                                               ; preds = %12, %17, %21, %25, %29, %33, %37, %41, %45
  %50 = phi i16 [ %15, %12 ], [ %15, %17 ], [ %24, %21 ], [ %24, %25 ], [ %32, %29 ], [ %32, %33 ], [ %40, %37 ], [ %40, %41 ], [ %48, %45 ]
  %51 = icmp eq i16 %50, -8826
...
!5 = !{!"Simple C/C++ TBAA"}
!6 = !{!7, !3, i64 0}
!7 = !{!"xdp_md", !3, i64 0, !3, i64 4, !3, i64 8, !3, i64 12, !3, i64 16}
!8 = !{!7, !3, i64 4}
!9 = !{!10, !10, i64 0}
!10 = !{!"short", !4, i64 0}
